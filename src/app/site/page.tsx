  ...
  return (
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col ">
        ...
        <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative lg:mb-16">
          <h1 className="text-9xl font-bold text-center md:text-[200px] lg:text-[250px]">
            Web Agency
          </h1>
        </div>
